...
public class justin_song extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_justin_song);
        ...
        song1 = MediaPlayer.create(this,R.raw.yummy);
        song2 = MediaPlayer.create(this,R.raw.never_say_never);
        song3 = MediaPlayer.create(this,R.raw.heart_breaker);
        song4 = MediaPlayer.create(this,R.raw.i_dont);
        song5 = MediaPlayer.create(this,R.raw.all_i_want);
        song6 = MediaPlayer.create(this,R.raw.confident);
        song7 = MediaPlayer.create(this,R.raw.heart_breaker);
    ...
    public void title(){
        if(song == 1){
            songTitle.setText("Yummy");
        }

        else if(song == 2){
            songTitle.setText("Never say Never");
        }

        else if(song == 3){
            songTitle.setText("Heart Breaker");
        }

        else if(song == 4){
            songTitle.setText("I Don't Care");
        }

        else if(song == 5){
            songTitle.setText("All I Want For Christmas Is You");
        }

        else if(song == 6){
            songTitle.setText("Confident");
        }

        else{
            songTitle.setText("Friends");
        }
